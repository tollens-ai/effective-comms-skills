# Plan the reader's path through a document

Outline long, multi-document, or structurally complex communications before drafting prose.
Name the sections and the reader question each answers, then check the outline against the
objective and audience. Use the following questions where they help organize the material;
the outline need only be detailed enough to expose gaps, duplication, or a confusing order.
