...
3. **Knowledge model** — answer all six: what they **need** / **don't need** / **want** / **don't want** to know, what they **already know**, and what you **might be falsely assuming** they know. The last cell is highest-value — assumed-context failures hide there. Never skip it, even for a short output. Any term the reader has not themselves used — the author's coinages, other agents' or tools' jargon, domain shorthand — belongs in the falsely-assuming cell by default: mentioning a term to the reader, or receiving it from another agent, is not the reader adopting it; it counts as known only once the reader has used it back.
...
| C12 | **No jargon the reader hasn't shown they hold.** Terms are used only when you KNOW they are ready-to-hand for this reader — they have used them themselves. Everything else — the author's coinages, other agents' vocabulary, tool and domain jargon — is translated into the reader's words or glossed at first use, identifiers parenthetical at most. | Any agent's private ontology keyed into a report as if shared; a worker's jargon passed through as author-endorsed; the audience review waved past it because the author asserted the reader "knows the terms". |
