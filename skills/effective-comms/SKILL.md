...
| Ready to write a routine, low-stakes reply | Use the quick preparation and self-review path in `/comms-prep`, then deliver. |
...
| A routine, low-stakes draft exists | Use the quick preparation and self-review path in `/comms-prep`, then deliver. |
